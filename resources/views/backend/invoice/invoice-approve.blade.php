          ...
          <section class="col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a class="btn btn-success btn-sm float-right" href="{{route('invoice.pending.list')}}">
                    ...
                    <table border="1" width="100%" class="table table-bordered  table-hover">
                        <thead>
                            <tr class="text-center">
                                ...
                                <th>Category</th>
                                <th>Product Name</th>
                                <th class="text-center" style="background: #ddd;">
                                  Current Stock</th>
                                <th>Quantity</th>
                                <th>Unit Price</th>
                                <th>Total Price</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($invoice['invoice_details'] as $key => $details)
                              <tr class="text-center">
                                  ...
                                  <input type="hidden" name="selling_qty[{{$details->id}}]" value=
                                  "{{$details->selling_qty}}">
                                  <td>{{$key+1}}</td>

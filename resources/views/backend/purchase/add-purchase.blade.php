...
<!-- Content Wrapper. Contains page content -->
          ...
          <section class="col-md-12 ">  
            ...
            <div class="card">
              <div class="card-header">
                  <h3>Add Purchase
                  <a href="{{ route('purchase.view') }}" class="btn btn-success float-right btn-sm">
  ...
  <script id="document-template" type="text/x-handlebars-template">
    <tr class="delete_add_more_item" id="delete_add_more_item">
        ...
        <td>
            <input class="form-control form-control-sm text-right buying_price" name="buying_price[]"
             value="0" readonly>
        </td>

...
<head>
  ...
  <script src="{{asset('public/backend/dist')}}/js/gijgo.min.js" type="text/javascript"></script>
  <link href="{{asset('public/backend/dist')}}/css/gijgo.min.css" rel="stylesheet" type="text/css" />
...
<div class="wrapper">
  ...
  <footer class="main-footer">
    ...
    <div class="float-right d-none d-sm-inline-block">
      <b>Designed & Developed by</b> Wasi Uddin
    </div>
  </footer>
